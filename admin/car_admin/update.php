        ...
        <form action="<?php echo($rootUrl . 'admin/car_admin/post_update.php'); ?>" method="POST">
            ...
            <?php } else { ?>
                ...
                <div class="part-form">
                    ...
                    <input type="text" class="form-control" id="car_title" name="car_title" aria-describedby="title-help" value="<?php echo($getData['car_title']); ?>" placeholder="<?php echo($getData['car_title']); ?>" autocomplete="off" required>
                </div>
                <div class="part-form">
                ...
                <div class="part-form">
                    ...
                    <input type="text" class="form-control" placeholder="URL de l'image" id="car_photo" name="car_photo" value="<?php echo strip_tags($getData['car_photo']); ?>" autocomplete="off" required>
                </div>

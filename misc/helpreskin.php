...
<main>
    <section>
        <h1 class="help">Aides</h1>
        <div class="grid-help">
            <a href="tutoriels.php" class="tutoriels">
                <div>
                    <h3 class="h3card">Tutoriels</h3>
                </div>
            </a>
            <a href="" class="vmt_vtf">
                <div>
                    <h3 class="h3card">Maintenance</h3>
                </div>
            </a>
            <a href="decals.php" class="decals">
                <div>
                    <h3 class="h3card">Decals</h3>
                </div>
            </a>
        </div>
    </section>

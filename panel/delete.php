									...
									<form action="" method="post">
                                        ...
                                        <?php if(($_GET['category'] === 'other')) { ?>
											<div class="part-form">
												...
												<input type="text" class="form-control" id="url" name="url" placeholder="Lien Direct vers le contenu" value="<?php echo($item['url']) ?>" autocomplete="off" maxlength="512" required readonly>
											</div>
                                        <?php } ?>
										<div class="part-form">

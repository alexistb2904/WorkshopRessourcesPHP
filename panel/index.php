                ...
                <div id="template-b-div">
                    <?php if (!empty(getSelfTable('other'))) { ?>
                        ...
                        <div class="download-card">
                            ...
                            <div style="display: flex; flex-direction: column; width: 100%; align-items: center; justify-content: center;">
                                <a class="download-card-button" id="edit-b" href="edit.php?id=<?php echo($item['id']) ?>&category=other">Modifier</a>
                                <a class="download-card-button" id="delete-b" href="delete.php?id=<?php echo($item['id']) ?>&category=other">Supprimer</a>
                            </div>
                        </div>
                        <?php } ?>

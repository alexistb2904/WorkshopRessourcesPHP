...
<head>
    ...
    <meta name="description"
        content="Optimisez vos projets avec WorkshopRessource : découvrez nos templates sélectionner pour novalife.">
    <meta name="keywords"
    ...
    <main>
        <section class="header-text">
            <div>
                ...
                <p>Une liste des templates pour
                    <?php echo ($titleOfPage) ?>
                </p>
            </div>
        ...
        <section class="download-container">
            <?php
            $titleOfPageLow = strtolower('novalife');
            if (!isset($_GET['page'])) {
                $page = 1;
            } else {
                $page = $_GET['page'];

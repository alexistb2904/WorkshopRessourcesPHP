...
<main>
    <section class="header-text">
        <div>
            <h1><?php echo($titleOfPage)?></h1>
            <p>Une liste des templates de <?php echo($titleOfPage)?></p>
        </div>
    </section>
	...
	<section class="header-text">
		<div>
			<p>Voici le lien vers le site de <?php echo($titleOfPage)?> <a href="https://svn.code.sf.net/p/tdmcarssvn/code/trunk/">ICI</a></p>
		</div>
	</section>
</main>

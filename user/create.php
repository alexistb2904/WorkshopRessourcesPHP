...
<div style="display: flex; flex-direction: column">
	...
	<form action="<?php echo($rootUrl . 'user/post_create.php'); ?>" method="POST" id="form-create">
		...
		<div class="part-form">
			...
			<p>Dans la limite des <strong>512</strong> caractères</p>
...
<script>
    document.getElementById("form-create").addEventListener("submit", function(event) {
        ...
        const photoValue = photoInput.value.length;
        if (photoValue >= 512) {
            alert("L'url de l'image doit faire moins de 512 caractères (actuellement " + photoValue + " caractères)");
